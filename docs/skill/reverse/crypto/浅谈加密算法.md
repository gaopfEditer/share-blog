...
4.  浏览器内置 Base64 编码（btoa） 解码（atob）
    ...
    ![image-20200828054526066](https://img.gaopf.top/image-20200828054526066.png)
...
![image-20200828071854891](https://img.gaopf.top/image-20200828071854891.png)
...
![image-20200828074126613](https://img.gaopf.top/image-20200828074126613.png)
...
![image-20200828073118836](https://img.gaopf.top/image-20200828073118836.png)

会弹出一个窗口，上面是选择对应的 js 文件，下面是测试加密用的，自己输入原文点击加密就能得到密文

![image-20200828073206109](https://img.gaopf.top/image-20200828073206109.png)
