...
## 代码规范化[](https://3rcd.com/wiki/nestjs-practise/chapter1#代码规范化)

具体代码与配置请自行查看源代码

### 代码风格[](https://3rcd.com/wiki/nestjs-practise/chapter1#代码风格)
...
#### 一些重要的规则[](https://3rcd.com/wiki/nestjs-practise/chapter1#一些重要的规则)

> 其余配置自行查看代码

设置解析文件为`tsconfig.eslint.json`(我们在"Tsconfig配置"部分新增这个文件)
...
### Tsconfig配置[](https://3rcd.com/wiki/nestjs-practise/chapter1#tsconfig配置)
...
## 开发工具[](https://3rcd.com/wiki/nestjs-practise/chapter1#开发工具)
