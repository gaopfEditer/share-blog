...
基于 Babel 对 JS 代码进行混淆与还原操作的网站 [JS 代码混淆与还原 (gaopf.top)](http://deobfuscator.gaopf.top/)
...
![image-20211224202108279](https://img.gaopf.top/image-20211224202108279.png)
...
针对上述还原操作其实还不够明显，于是就编写了一个在线对 JS 代码混淆与还原的网站（主要针对还原）– [JS 代码混淆与还原 (gaopf.top)](https://deobfuscator.gaopf.top/)
