...
在线地址：[http://rust-wasm-md5.gaopf.top](http://rust-wasm-md5.gaopf.top/) （不保证地址长期可用）

![](https://img.gaopf.top/image__XHPNCbC-B.png)

## 思考：为何不使用 js 的 md5 而是 wasm 的 md5

众所周知，你在浏览器中按下 F12 打开 DevTools，并选择源代码面板中就可以看到当前访问的网站的所有代码。

![](https://img.gaopf.top/image_6019y_U19n.png)

而对于一些具有熟练度的逆向分析者中，如果不经过任何处理的代码被打包到生产环境中能够快速的定位出某个功能的具体代码位置。

而通过 wasm 就能很有效的将代码隐藏起来，不让逆向分析者查看，就像下面这样

![](https://img.gaopf.top/image_BbA3n6wFws.png)

![](https://img.gaopf.top/image_81tgfDE_P7.png)
