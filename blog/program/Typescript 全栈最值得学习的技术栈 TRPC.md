...
image: https://img.gaopf.top/trpc-banner.png
...
在线体验地址：[TRPC demo](https://trpc.gaopf.top/)
...
![image-20230308142331808](https://img.gaopf.top/image-20230308142331808.png)
...
![image-20230308142452678](https://img.gaopf.top/image-20230308142452678.png)
...
![](https://img.gaopf.top/image_YDKc7TixQA.png)
...
![](https://img.gaopf.top/image_WfW8ehqUKz.png)

![](https://img.gaopf.top/image_qicvoGjshx.png)
...
调用 `trpc.greeting.useQuery({ name: 'gaopf' })` 发送的请求的 query 参数则变为

![](https://img.gaopf.top/20230307214659.png)
...
![](https://img.gaopf.top/image_ufrhaugaIj.png)

![](https://img.gaopf.top/image_cvlDJjhwPl.png)

分别输出三者 result 也没有任何问题。

![](https://img.gaopf.top/image_hbL8So_RzB.png)
...
![](https://img.gaopf.top/image_-qEI8jR1uM.png)

![](https://img.gaopf.top/image_RTdWJn_55p.png)
...
![](https://img.gaopf.top/image_8BUcBPK8In.png)
...
![](https://img.gaopf.top/image_ERGzEt2Tq8.png)
...
![](https://img.gaopf.top/image_QBXnHdoewh.png)
...
![](https://img.gaopf.top/image__B1RYeiFze.png)
...
export const authOptions: NextAuthOptions = {
  ...
  providers: [
    CredentialsProvider({
      name: 'Credentials',
      credentials: {
        username: { label: 'Username', type: 'text', placeholder: 'gaopf' },
        password: { label: 'Password', type: 'password' },
      },
      async authorize(credentials, req) {
        // Add logic here to look up the user from the credentials supplied
        const user = { id: '1', name: 'gaopf', email: '1241961245@qq.com' }
...
![](https://img.gaopf.top/image_9eowvvnwU2.png)
...
![](https://img.gaopf.top/image_7_XKmbuK87.png)
...
这里我提供了一个简单的示例，你可以 [点我](https://trpc.gaopf.top) 访问体验一下（项目部署在 Vercel，而数据库服务在腾讯云，登录服务又依赖 Github，所以项目会稍微有那么慢）。整个项目结构大致如下

![](https://img.gaopf.top/image_z_YaR-RnSu.png)
