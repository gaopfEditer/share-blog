...
image: https://img.gaopf.top/202312270300876.png
---
...
![image-20220825131929320](https://img.gaopf.top/image-20220825131929320.png)
...
![image-20220825132235027](https://img.gaopf.top/image-20220825132235027.png)

### 权限分配

双击角色可以到权限分配页面，比方说我想给 Authenticated 角色分配 Restaurant 表中查询数据，就可以按照如下选项中勾选，并且勾选其中一个权限（增删改查）可以在右侧看到对应的请求 api 接口（路由）

![image-20220825132716257](https://img.gaopf.top/image-20220825132716257.png)
...
![image-20220825132948740](https://img.gaopf.top/image-20220825132948740.png)
