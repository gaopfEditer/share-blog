...
image: https://img.gaopf.top/202312270248371.png
---
...
```bash
deno run https://deno.gaopf.top/main.ts
```

在第一次使用时下载并缓存代码，你可以通过

```bash
deno info http://deno.gaopf.top/main.ts
```

来查看文件信息，如下

![](https://img.gaopf.top/image_deb0_lGYRA.png)
