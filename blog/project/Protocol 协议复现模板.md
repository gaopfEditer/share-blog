...
![](https://img.gaopf.top/image_75GsdEZuLK.png)
...
export class Blog {
  ...
  constructor(user: User) {
    this.http = new AHttp({ baseURL: 'https://blog.gaopf.top' })
    this.user = User
  }
